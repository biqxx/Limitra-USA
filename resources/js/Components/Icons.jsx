const I = {
  ...
  linkedin: (p) => (<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M6.94 8.5H3.56V20H6.94V8.5ZM5.25 7c1.15 0 2-.85 2-1.95S6.4 3.1 5.25 3.1 3.25 3.95 3.25 5.05 4.1 7 5.25 7ZM20.5 20h-3.38v-6.02c0-1.48-.53-2.49-1.85-2.49-1.01 0-1.61.68-1.87 1.34-.1.24-.12.57-.12.9V20H9.9s.05-10.6 0-11.5h3.38v1.63c.45-.7 1.25-1.68 3.04-1.68 2.22 0 3.88 1.45 3.88 4.56V20Z"/></svg>),
  snapchat: (p) => (<svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M12 2.5c2.68 0 4.55 2 4.68 4.4.04.72.02 1.4 0 2.02l-.01.3c0 .17.08.24.16.28.13.06.34.03.6-.06.2-.07.42-.03.6.08a.72.72 0 0 1 .1 1.09c-.42.5-1.1.9-2.03 1.19-.06.28 0 .58.19.9.35.6 1.05 1.07 2.08 1.4.28.1.46.37.43.66-.05.53-.72.85-1.15 1a4.6 4.6 0 0 1-1 .22c-.07.14-.13.34-.18.5-.08.28-.24.55-.72.55-.32 0-.62-.06-1.16-.14a3.5 3.5 0 0 0-.72-.08c-.42 0-.75.15-1.14.4-.6.4-1.28.85-2.33.85s-1.73-.45-2.33-.85c-.39-.25-.72-.4-1.14-.4-.28 0-.5.05-.72.08-.54.08-.84.14-1.16.14-.48 0-.64-.27-.72-.55-.05-.16-.11-.36-.18-.5a4.6 4.6 0 0 1-1-.22c-.43-.15-1.1-.47-1.15-1a.66.66 0 0 1 .43-.66c1.03-.33 1.73-.8 2.08-1.4.19-.32.25-.62.19-.9-.93-.29-1.61-.7-2.03-1.19a.72.72 0 0 1 .1-1.09c.18-.11.4-.15.6-.08.26.09.47.12.6.06.08-.04.16-.11.16-.28l-.01-.3a17.7 17.7 0 0 1 0-2.02C7.45 4.5 9.32 2.5 12 2.5Z"/></svg>),
