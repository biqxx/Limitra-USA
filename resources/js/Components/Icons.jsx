const I = {
  ...
  tiktok: (p) => (<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" {...p}><path d="M19.6 5.9A4.8 4.8 0 0 1 16.3 4v8.8a5.3 5.3 0 1 1-3.8-5.1v3a2.3 2.3 0 1 0 1.8 2.2V4h3.3a4.8 4.8 0 0 0 2 1.9Z"/></svg>),
