...
use App\Http\Controllers\EngagementViewController;
...
Route::post('/products/{id}/track-view', [EngagementViewController::class, 'product'])->name('products.track-view')->middleware('throttle:60,1');
Route::get('/collection/{type}', [CollectionController::class, 'show'])->name('collection.show');
Route::get('/article/{slug}', [ArticleController::class, 'show'])->name('article.show');
Route::post('/articles/{slug}/track-view', [EngagementViewController::class, 'article'])->name('articles.track-view')->middleware('throttle:60,1');
...
Route::middleware('admin')->group(function () {
    ...
    Route::post('/admin/videos/reorder', [AdminController::class, 'reorderVideos'])->name('admin.videos.reorder');
